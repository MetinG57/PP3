...
<details>
   ...
   Rauten markieren Überschriften. Je mehr Rauten, desto kleiner die Überschrift: z:B. eine einzige Raute große Überschrift; ## kleinere Überschrift etc.
</details>
<details>
...
<details>
    ...
    <code>
     ...
     Listen: Mit -, * oder + anfangen z.B.:
    - Punkt 1
    - Punkt 2
         
oder mit Mit Zahlen und Punkt z.B.:
 1. Erster Punkt
 2. Zweiter Punkt

     Tabellen: Mit senkrechten Strichen (|) und Bindestrichen (-) erstellen, z. B.:
...
<details>
    ...
    Der LaTeX-Compiler erzeugt example.pdf, main.aux und main.log
</details>

<details>
    <summary>How do you change the name of the pdf-file?</summary>
    Den Namen der PDF-Datei ändert man mit dem -jobname Parameter im pdflatex-Befehl
</details>
...
<details>
    ...
    Die PDF nutzt ein Buch-Layout mit Kapiteln und zweiseitiger Struktur.
</details>
<details>
    <summary>What changes in your pdf, if you add <code>\section{Intro}</code> after <code>\maketitle</code></summary>
    Eine nummerierte Überschrift "1 Intro" wird in der PDF hinzugefügt.
</details>
